...
2. What is an event?
An event is something that the user initiates on the page

3. What is an event listener?
An event listener is what looks for the user initiated key at a given element level

4. Why would we convert a NodeList into an Array?
To allow you to be able to use common array methods to access data

5. What is a component?
a component is a reusable bit of code to return HTML elements
